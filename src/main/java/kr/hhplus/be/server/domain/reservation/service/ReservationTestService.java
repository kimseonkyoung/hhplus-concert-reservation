...
public class ReservationTestService {
    ...
    public void reserveSeatOptimistic(ReservationSearviceRequest reservationSearviceRequest) {
    }

    public void reserveSeatPessimistic(ReservationSearviceRequest reservationSearviceRequest) {
    }
}
