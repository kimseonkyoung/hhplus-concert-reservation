...
import kr.hhplus.be.server.application.common.mapper.ReservationDtoConverter;
import kr.hhplus.be.server.application.usecase.ConcertReservationFacade ;
import kr.hhplus.be.server.application.common.mapper.ConcertDtoConvert;
...
public class ControllerApplicationTest {
    ...
    void test9 () throws Exception {
        Reservation reservations = Reservation.create(1L);
        ReservationRequest request = new ReservationRequest(1L,2L,1L,"6asd-65465fasd4f-5465");

        // Entity -> Service Dto
        ReservationServiceResponse serviceReponse = ReservationEntityConverter.toServiceReservationResponse(reservations);

        // Service Dto -> Controller Dto
        ReservationResponse response = ReservationDtoConverter.toControllerReservationResponse(serviceReponse);

        // Service Mock 설정
        given(facade.reserveSeat(request, "6asd-65465fasd4f-5465")).willReturn(response);
